...
namespace BeatSyncPlaylists
{
    public static class PlaylistManagerExtensions
    {
        ...
        private static IPlaylist CreateBuiltinPlaylist(this PlaylistManager manager, BuiltInPlaylist builtInPlaylist)
        {
            ...
            manager.AddToCustomPlaylists(playlist);
            return playlist;
        }
        ...
        public static IPlaylist GetOrCreateAuthorPlaylist(this PlaylistManager manager, string authorName)
        {
            ...
            if (manager.TryGetCustomPlaylist(fileName, out IPlaylist? existing) && existing != null)
                return existing;
            ...
            manager.AddToCustomPlaylists(newPlaylist);
            return newPlaylist;
        }
    }
}
